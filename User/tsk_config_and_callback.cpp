...
void Task1ms_TIM5_Callback()
{
	...
	if (interaction_mod10 == 10)
	{
		...
		// tempFloat[0+8]=RoboticArm.arm_motor1.Get_Now_Angle()*180/PI;
		// tempFloat[1+8]=RoboticArm.arm_motor1.Get_Now_Omega()*180/PI;
		// tempFloat[2+8]=RoboticArm.arm_motor1.Get_Now_Torque();
		// tempFloat[3+8]=RoboticArm.arm_motor2.Get_Now_Angle()*180/PI;
		// tempFloat[4+8]=RoboticArm.arm_motor2.Get_Now_Omega()*180/PI;
		// tempFloat[5+8]=RoboticArm.arm_motor2.Get_Now_Torque();
		// tempFloat[6+8]=RoboticArm.arm_motor3.Get_Now_Angle()*180/PI;-
		// tempFloat[7+8]=RoboticArm.arm_motor3.Get_Now_Omega()*180/PI;
		// tempFloat[8+8]=RoboticArm.arm_motor3.Get_Now_Torque();
		...
		tempFloat[0]=IMUdata[0]*180/PI;
		tempFloat[1]=IMUdata[1]*180/PI;
		tempFloat[2]=IMUdata[2]*180/PI;
		tempFloat[3]=IMUdata[3]*180/PI;
...
void Task_Init()
{
	...
	UART_DMA_Receive_init(&huart2, buffer_receive_2, buffer_receive_length_2);//配置串口2接收陀螺仪
	UART_DMA_Receive_init(&huart3, buffer_receive_3, buffer_receive_length_3);//配置串口3接收摄像头
