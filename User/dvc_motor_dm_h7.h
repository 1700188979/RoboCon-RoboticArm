 ...
 *
 */
struct Struct_Motor_DM_FDCAN_Rx_Data_Normal
{
    uint8_t FDCAN_ID : 4;
 ...
 *
 */
struct Struct_Motor_DM_FDCAN_Rx_Data_1_To_4
{
 ...
 *
 */
struct Struct_Motor_DM_FDCAN_Tx_Data_Normal_MIT
{
 ...
 *
 */
struct Struct_Motor_DM_FDCAN_Tx_Data_Normal_Angle_Omega
{
    float Control_Angle;
    float Control_Omega;
} __attribute__((packed));
 ...
 *
 */
struct Struct_Motor_DM_FDCAN_Tx_Data_Normal_Omega
{
    float Control_Omega;
} __attribute__((packed));
 ...
 *
 */
struct Struct_Motor_DM_FDCAN_Tx_Data_Normal_EMIT
{
    float Control_Angle;
    // 限定速度用, rad/s的100倍
...
public:
    ...
    void Init(FDCAN_HandleTypeDef *hfdcan, uint8_t __FDCAN_Rx_ID, uint8_t __FDCAN_Tx_ID, Enum_Motor_DM_Control_Method __Motor_DM_Control_Method = Motor_DM_Control_Method_NORMAL_MIT, float __Angle_Max = 12.5f, float __Omega_Max = 25.0f, float __Torque_Max = 10.0f, float __Current_Max = 10.261194f);
    ...
    void FDCAN_Send_Clear_Error();

    void FDCAN_Send_Enter();

    void FDCAN_Send_Exit();

    void FDCAN_Send_Save_Zero();
...
protected:
    ...
    // 收数据绑定的FDCAN ID, 与上位机驱动参数Master_ID保持一致
    uint16_t FDCAN_Rx_ID;
    // 发数据绑定的FDCAN ID, 是上位机驱动参数FDCAN_ID加上控制模式的偏移量
    uint16_t FDCAN_Tx_ID;
...
public:
    ...
    void Init(FDCAN_HandleTypeDef *hfdcan, Enum_Motor_DM_Motor_ID_1_To_4 __FDCAN_Rx_ID, Enum_Motor_DM_Control_Method __Motor_DM_Control_Method = Motor_DM_Control_Method_1_TO_4_ANGLE, int32_t __Encoder_Offset = 0, float __Current_Max = 10.261194f);
...
protected:
    ...
    // 绑定的FDCAN
    Struct_FDCAN_Manage_Object *FDCAN_Manage_Object;
    // 收数据绑定的FDCAN ID, 达妙系列0x301~0x308
    Enum_Motor_DM_Motor_ID_1_To_4 FDCAN_Rx_ID;
    // 编码器偏移
